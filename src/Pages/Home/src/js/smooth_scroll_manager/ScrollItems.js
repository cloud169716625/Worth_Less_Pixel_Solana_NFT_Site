...
export default class ScrollItems {
  ...
  init() {
    ...
    for (let i = 0; i < elmScrollItems.length; i++) {
      this.scrollItems[i] = new ScrollItem(
        elmScrollItems[i],
        this.scrollManager
      );
    }
    for (let i = 0; i < elmSmoothItems.length; i++) {
    ...
    for (let i = 0; i < elmParallaxItems.length; i++) {
  ...
  resize() {
    ...
    for (let i = 0; i < this.smoothItems.length; i++) {
